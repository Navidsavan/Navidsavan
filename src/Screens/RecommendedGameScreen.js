...
import { View, Text, Image, StyleSheet, Dimensions, TouchableWithoutFeedback, Keyboard, TouchableOpacity, TextInput, Alert, FlatList } from 'react-native';
import colors from '../Colors/Color';
import { RFPercentage as rfp, RFPercentage, RFValue as rfv } from "react-native-responsive-fontsize";
import { Icon } from 'react-native-elements';
import { RecommendedGamesModel, ResetGameNumbers, GamesSlotsNumbers } from '../store/actions/TicketGameActions';
...
const RecommendedGameScreen =props=> {
   let  current_numbers=props.route.params.currentNumbers;
    ...
    const [currentNumbers, setCurrentNumbers]=useState(current_numbers);
    ...
    // let gameNumbers = useSelector(state => state.modelData.RecommendedGameModelData);
            ...
            <View style={styles.modalView}>
                ...
                <View style={styles.headerContainer}>
                    ...
                    <View>
                        ...
                        <Image source={require('../Images/dashboardIcons/recommendedGame.png')} style={styles.modelImageStyle} />
                        <Text style={styles.modelTitleText}>Show Recommended Games</Text>
                ...
                <View style={styles.addButtonContainer}>
                    ...
                    <View>
                        ...
                        <FlatList
                            data={currentNumbers.length>0? currentNumbers : tempNumbers}
...
export default RecommendedGameScreen;