...
const RecommendedSlotScreen = props => {
   ...
   // const [slotNumbers, setSlotNumbers] = useState(current_numbers);
    ...
    // const slotNumbers = useSelector(state => state.RecommendedSlotModelData.SlotsData);
            ...
            <View style={styles.modalView}>
                ...
                <View style={styles.modelCloss}>
                    ...
                    <View>
                        ...
                        <Image source={require('../Images/dashboardIcons/recommendedSlot.png')} style={styles.modelImageStyle} />
                        <Text style={styles.modelTitleText}>Show Ticket On Slot Number</Text>
                        {isSubmitted ?
                ...
                <View style={styles.inputView}>
                    ...
                    <View style={styles.gameInputContainer}>
                        <Text style={styles.inputlebel}>Enter Slot Number</Text>
                        <TextInput
...
export default RecommendedSlotScreen;